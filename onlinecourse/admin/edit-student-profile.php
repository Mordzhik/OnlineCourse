 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Регистрация Студента  </h1>
                    </div>
                </div>
                <div class="row" >
...
{ ?>
 ...
 <div class="form-group">
    <label for="studentregno">Регисрационный номер   </label>
...
<div class="form-group">
    <label for="Pincode">Пинкод </label>
...
<div class="form-group">
    <label for="studentphoto">Фото студента  </label>
...
<div class="form-group">
    <label for="studentphoto">Добавить фото  </label>
