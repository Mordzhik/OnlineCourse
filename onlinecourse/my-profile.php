 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Регистрация сотрудника </h1>
                    </div>
                </div>
                <div class="row" >
...
{ ?>
   ...
   <div class="form-group">
    <label for="studentname">ФИО сотрудника  </label>
    <input type="text" class="form-control" id="studentname" name="studentname" value="<?php echo htmlentities($row['studentName']);?>"  />
  </div>

 <div class="form-group">
    <label for="studentregno">Регистрационный номер   </label>
...
<div class="form-group">
    <label for="Pincode">Загрузить фото  </label>
