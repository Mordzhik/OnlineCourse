...
<head>
    <meta charset="utf-8">
    <title>Зарегистрированные курсы</title>
...
{?>
   ...
   <?php } ?>
                            ...
                            <td>
                               <b> Регистрационный номер: </b><?php echo htmlentities($_SESSION['login']);?><br>
                               <b> ФИО студента: </b>  <?php echo htmlentities($row['studentname']);?><br>
                               <b> Дата регистрации:</b> <?php echo htmlentities($row['studentregdate']);?><br>
                                <b> Запись на курс:</b> <?php echo htmlentities($row['edate']);?><br>
                            </td>
                        </tr>
                    </table>
                </td>
