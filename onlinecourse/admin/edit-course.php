 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Курс  </h1>
                    </div>
                </div>
                <div class="row" >
...
{
?>
<p><b>Посл обновления</b> :<?php echo htmlentities($row['updationDate']);?></p>
   <div class="form-group">
    <label for="coursecode">Курс код  </label>
...
<div class="form-group">
    <label for="courseunit">Значение </label>
...
<div class="form-group">
    <label for="seatlimit">Лимит мест </label>
...
<?php } ?>
 <button type="submit" name="submit" class="btn btn-default"><i class=" fa fa-refresh "></i> Обновить</button>
</form>
                            </div>
                            </div>
                    </div>
