...
{?>
   ...
   <?php } ?>
                            ...
                            <td>
                               <b> Рег номер: </b><?php echo htmlentities($row['sregno']);?><br>
                               <b> ФИО студента: </b>  <?php echo htmlentities($row['studentname']);?><br>
                               <b> Студент рег дата:</b> <?php echo htmlentities($row['studentregdate']);?><br>
                                <b> </b> <?php echo htmlentities($row['edate']);?><br>
                            </td>
                        </tr>
                    </table>
                </td>
