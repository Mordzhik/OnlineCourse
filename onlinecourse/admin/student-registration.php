...
<head>
    ...
    <title>Admin | Регистрация сотрудника</title>
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
 ...
 <div class="form-group">
    <label for="studentregno">Рег номер  </label>
...
<div class="form-group">
 ...
 <button type="submit" name="submit" id="submit" class="btn btn-default">Подтвердить</button>
</form>
                            </div>
                            </div>
                    </div>
