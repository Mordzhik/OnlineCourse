...
{ ?>
 ...
 <div class="form-group">
    <label for="studentregno">Регистрационный номер студента  </label>
...
<div class="form-group">
    <label for="Pincode">ФОТО студента </label>
...
<div class="form-group">
    <label for="Department"> Факльтет</label>
...
<div class="form-group">
   ...
   <option value="">Выбрать семестр</option>   
   <?php 
...
<?php } ?>
 ...
 <button type="submit" name="submit" id="submit" class="btn btn-default">Регистрация</button>
</form>
                            </div>
                            </div>
                    </div>
